  ...
  fields: [
          ...
          fields: [
            {
              ...
              title: "Type",
              type: "string",
              options: { list: ["info", "tip", "warning", "success"] },
              initialValue: "tip",
            },
    ...
    defineField({
      ...
      fields: [
        {
          name: "metaTitle",
          title: "Meta Title (overrides post title)",
          type: "string",
          validation: (R: any) => R.max(70),
        },
        {
          name: "metaDescription",
          title: "Meta Description (overrides excerpt)",
          type: "text",
          validation: (R: any) => R.max(160),
        },
        {
          name: "ogImage",
          title: "OG Image (overrides cover image)",
          type: "image",
          options: { hotspot: true },
        },
      ],
