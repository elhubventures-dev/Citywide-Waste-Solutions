...
export const serviceSchema = defineType({
  ...
  fields: [
    ...
    defineField({ name: "price", title: "Price Display (e.g. From $30/month)", type: "string" }),
    defineField({
      name: "features",
      title: "Key Features",
      type: "array",
...
export const serviceAreaSchema = defineType({
  ...
  fields: [
    ...
    defineField({ name: "population", title: "Population (e.g. 350,000+)", type: "string" }),
    defineField({
      name: "coords",
      title: "Coordinates",
      type: "object",
...
export const pricingTierSchema = defineType({
  ...
  fields: [
    ...
    defineField({ name: "period", title: "Period (e.g. /month, starting)", type: "string" }),
...
export const faqSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "isGeneral",
      title: "Show on General FAQ page?",
      type: "boolean",
      initialValue: false,
    }),
    defineField({ name: "order", title: "Display Order", type: "number", initialValue: 0 }),
...
export const testimonialSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "role",
      title: "Role / Location (e.g. Homeowner, Vaughan)",
      type: "string",
    }),
    defineField({
      name: "rating",
