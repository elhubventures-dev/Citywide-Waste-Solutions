...
export const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Scalable waste solutions for offices, restaurants, retail, and industrial sites. Compliance, reliability, and transparent reporting.",
    color: "blue",
    price: "Custom Quote",
    features: [
  ...
  },
  {
    ...
    description:
      "Efficient debris removal for renovation and construction sites. Concrete, lumber, drywall, and mixed load removal at competitive rates.",
    color: "earth",
    price: "Custom Quote",
    features: [
