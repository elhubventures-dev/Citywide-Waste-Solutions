...
import { MOVING_SERVICE_AREAS_SHORT } from "@/lib/moving/constants";

export const metadata = buildMovingMetadata({
  title: `${MOVING_BUSINESS.name} | Professional Moving Services in Ontario`,
  description:
    `Citywide Moving Solutions offers residential, commercial, and long-distance moving across ${MOVING_SERVICE_AREAS_SHORT}. Packing, loading, and furniture assembly. Get a free quote today.`,
  path: "/",
});
