...
export default async function ServiceAreaPage({ params }: { params: { slug: string } }) {
  ...
  const sanityArea = await sanityFetch<any>(serviceAreaBySlugQuery, { slug: params.slug }, [
    "service-areas",
  ]).catch(() => null);
  ...
  return (
    <>
      ...
      <MotionSection className="bg-background">
        <div className="grid gap-16 lg:grid-cols-3">
          ...
          <div className="space-y-12 lg:col-span-2">
                ...
                {SERVICES.map((service) => {
                  ...
                  return (
                    <StaggerItem key={service.slug}>
                      ...
                      >
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-green-100 text-green-600 transition-colors group-hover:bg-green-500 group-hover:text-white dark:bg-green-950/40">
            ...
            {/* Map embed */}
            <div>
              <h2 className="mb-4 text-2xl font-bold text-foreground">Our Coverage in {name}</h2>
          ...
          <div>
            ...
            >
              <h2 className="mb-1 text-lg font-bold text-foreground">Free Quote — {name}</h2>
      ...
      <MotionSection className="bg-section-alt">
        <h2 className="mb-6 text-xl font-bold text-foreground">Other Areas We Serve</h2>
