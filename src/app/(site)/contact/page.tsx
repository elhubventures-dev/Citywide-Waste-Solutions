...
export const metadata: Metadata = {
  ...
  description:
    `Get in touch with ${BUSINESS.name}. Request a free quote, schedule a pickup, or ask us anything. Serving Vaughan, Toronto, Brampton, Mississauga & Courtice.`,
};
          ...
          <div className="grid gap-16 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-xl border border-border bg-card p-4 shadow-card text-sm">
                  <p className="font-semibold text-foreground mb-2">Registered Business</p>
            ...
            <div className="lg:col-span-3 space-y-10">
              ...
              <div className="rounded-2xl border border-border bg-card p-6 shadow-card sm:p-8">
                <div className="mb-6 flex items-start gap-3">
                  <MessageSquare className="mt-0.5 h-5 w-5 text-green-500 shrink-0" />
                  <div>
