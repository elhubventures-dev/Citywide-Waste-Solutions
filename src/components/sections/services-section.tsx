              ...
              <StaggerItem key={service.slug}>
                ...
                >
                  ...
                  >
                    <Icon
                      className={cn(
                        "h-6 w-6 transition-transform duration-300 group-hover:rotate-3 group-hover:scale-110",
                        colors.iconText
                      )}
                    />
                  </div>
                  ...
                  <div className="flex-1 space-y-2.5">
                    <h3 className="text-lg font-bold text-foreground transition-colors group-hover:text-green-600">
                      {service.title}
                    </h3>
                  ...
                  <div className="mt-5 flex items-center justify-between border-t border-border pt-4">
                    ...
                    <span className="flex items-center gap-1 text-xs font-semibold text-green-600 opacity-0 transition-all duration-300 group-hover:translate-x-0.5 group-hover:opacity-100">
